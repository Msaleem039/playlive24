...
export const SplitApiSettings = createApi({
    ...
    endpoints: () => ({}),
    tagTypes: ['User', 'Wallet', 'Settlement', 'Positions', 'NewsBar', 'AccountStatement', 'BetHistory', 'AgentMatchBook', 'Complaints', 'AdminMatches', 'AcceptDelayOverrides', 'FancyStop', 'MatchOddsStop']
});