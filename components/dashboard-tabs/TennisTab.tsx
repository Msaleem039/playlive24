...
import { useGetTennisMatchesQuery } from "@/app/services/Api"
...
export default function TennisTab() {
  ...
  const { 
    ...
    error, 
    refetch 
  } = useGetTennisMatchesQuery(undefined, {
    skip: !mounted,
      ...
      <div className="bg-white">
        ...
        <div className="flex items-center justify-center py-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading tennis matches...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="bg-white">
        ...
        <div className="flex items-center justify-center py-8">
          <div className="text-center">
            ...
            <p className="text-red-600 mb-2">Error loading tennis matches</p>
            <button 
              onClick={() => refetch()}
      ...
      <div className="bg-[#00A66E] text-white px-2 sm:px-4 py-1 font-semibold flex items-center justify-between gap-2">
        <div className="flex items-center gap-1 sm:gap-2 min-w-0">
          ...
          {liveMatches.length > 0 && (
            <button 
              onClick={() => router.push('/live?sport=tennis')}
        ...
        <div className="flex items-center justify-center py-8 px-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              No {activeSubTab === 'live' ? 'live' : 'upcoming'} tennis matches found
            </p>
          </div>
        </div>
      ) : (
