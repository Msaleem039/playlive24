          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">Settlement ID</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">User</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">Match</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">Bet Name</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">Market</th>
                  <th className="px-6 py-4 text-center text-xs font-bold text-gray-700 uppercase">Amount</th>
                  <th className="px-6 py-4 text-center text-xs font-bold text-gray-700 uppercase">Odds</th>
                  <th className="px-6 py-4 text-center text-xs font-bold text-gray-700 uppercase">Status</th>
                  <th className="px-6 py-4 text-right text-xs font-bold text-gray-700 uppercase">Win</th>
                  <th className="px-6 py-4 text-right text-xs font-bold text-gray-700 uppercase">Loss</th>
                  <th className="px-6 py-4 text-right text-xs font-bold text-gray-700 uppercase">P/L</th>
                ...
                {allResults.map((result: any, index: number) => {
                  ...
                  <tr key={result.id || index} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="text-sm font-mono font-semibold text-gray-900" title={displaySettlementId}>
                        {displaySettlementId}
                      </span>
                    </td>
