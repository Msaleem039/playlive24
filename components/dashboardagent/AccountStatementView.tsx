    ...
    <div className="min-h-screen bg-gray-100 -mt-0">
      ...
      <div className="bg-white p-4 sm:p-6 shadow-sm border-b">
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
            <label className="text-sm font-bold text-gray-700 whitespace-nowrap">Choose from Date</label>
          ...
          {/* To Date */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
            <label className="text-sm font-bold text-gray-700 whitespace-nowrap">Choose to Date</label>
            <div className="relative">
              <Input
                type="text"
                value={toDate}
      ...
      {statementData && (
        <div className="bg-gray-50 px-4 py-3 border-b flex gap-6 text-sm">
          <div>
            <span className="text-gray-600 font-bold">Opening Balance: </span>
            <span className="font-bold text-gray-900">Rs {formatCurrency(statementData.openingBalance)}</span>
          </div>
          <div>
            <span className="text-gray-600 font-bold">Closing Balance: </span>
