            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-purple-50">
                  <tr>
                    <th className="px-4 xl:px-6 py-2 md:py-4 text-left text-xs font-bold text-purple-900 uppercase">Match ID</th>
                    <th className="px-4 xl:px-6 py-2 md:py-4 text-left text-xs font-bold text-purple-900 uppercase">Match Title</th>
                    <th className="px-4 xl:px-6 py-2 md:py-4 text-center text-xs font-bold text-purple-900 uppercase">Fancy Bets</th>
                    <th className="px-4 xl:px-6 py-2 md:py-4 text-right text-xs font-bold text-purple-900 uppercase">Amount</th>
                    <th className="px-4 xl:px-6 py-2 md:py-4 text-center text-xs font-bold text-purple-900 uppercase">Actions</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
