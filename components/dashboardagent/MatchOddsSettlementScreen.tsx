      ...
      <div className="flex-1 overflow-y-auto p-3 md:p-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-4 md:mb-6">
          <div className="bg-gray-50 px-3 md:px-6 py-3 md:py-4 border-b border-gray-200">
            <h3 className="font-bold text-base md:text-lg">Match Odds Settlements</h3>
          </div>
                  ...
                  {groupedSettlements.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={3} className="px-3 md:px-6 py-8 md:py-12 text-center">
                        <p className="text-gray-500 font-bold text-sm md:text-base">No match odds bets found</p>
                      </td>
                    </tr>
                  )}
                </tbody>
          ...
          <div className="p-3 md:p-6 space-y-3 md:space-y-4">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-2 md:gap-3 pt-3 md:pt-4 border-t border-gray-200">
              ...
              <Button
                ...
                className="px-4 md:px-6 py-2 md:py-2.5 rounded-lg text-white font-bold bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm md:text-base w-full sm:w-auto"
              >
    ...
    <div className="flex-1 overflow-y-auto p-3 md:p-6">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 bg-white rounded-xl shadow-sm border border-gray-200">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">No Match Odds Pending</h3>
