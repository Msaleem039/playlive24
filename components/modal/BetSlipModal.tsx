...
//     // Check if this is a fancy bet
//     const isFancyBet = selectedBet.marketGType === 'fancy' || selectedBet.marketGType === 'fancy2'
    
//     if (isFancyBet) {
//       // For fancy bets: odds might be in different format or calculation might be 1:1
//       // If odds represent market value directly, profit = stake (1:1 ratio)
//       // Otherwise, use standard calculation but check if odds need to be divided
//       // Based on user feedback: "on 500 you got 500 market value"
//       // This suggests fancy bets might use 1:1 calculation or odds/100
//       const fancyOddsValue = oddsValue >= 100 ? oddsValue / 100 : oddsValue
//       plText =
//         selectedBet.type === 'back'
//           ? `${(stakeValue * (fancyOddsValue - 1)).toFixed(2)} / ${stakeValue.toFixed(2)}`
//           : `${stakeValue.toFixed(2)} / ${(stakeValue * (fancyOddsValue - 1)).toFixed(2)}`
//     } else {
//       // Standard calculation for match_odds, bookmaker, oddeven, etc.
//       plText =
//         selectedBet.type === 'back'
